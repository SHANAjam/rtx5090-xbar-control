...
| 18:20 | +210 MHz | ✅ PASS, 0 errors |
| 18:30 | +205 MHz | ✅ PASS, 0 errors (chosen as new daily stable for extra margin) |

Conclusion for this card/driver: **+215 MHz is the highest tested L2-stable
XBAR offset** under the bundled L2 stress test; the user later chose
**+205 MHz as the daily stable setting** for additional safety margin.
